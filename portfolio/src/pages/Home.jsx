                 ...
                 <div className='flex-col flex min-[1121px]:flex-row min-[1121px]:gap-2 mt-0.5 h-[80px] min-[1130px]:h-0'>
                  ...
                  <p className="mt-4 text-[17px] min-[500px]:text-[16px] font-medium leading-6">
                   ...
                   <div className='mt-10 text-center'>
                     <a href="/MyResume.pdf" target='_blank' className='bg-[#b91c1c] text-white font-normal px-3 py-3 rounded-sm shadow hover:bg-transparent hover:text-black dark:hover:text-white hover:border-[1px] transition'>Download Resume</a>
                   </div>
             </div>
